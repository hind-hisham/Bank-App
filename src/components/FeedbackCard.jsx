...
const FeedbackCard=({content ,name,title,img})=>(
    <div className='flex justify-between flex-col px-10 py-12 rounded-xl max-w-[350px] md:mr-10 sm:mr-5 feedback-card'>
      <img src={quotes} alt="double-quotes" className="w-[42px] h-[27px] object-contain" />
      <p className="font-poppins text-[18px] leading-[32px] text-white my-10">{content}</p>
