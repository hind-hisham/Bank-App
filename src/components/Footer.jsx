...
const Footer=()=>(
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} flex-col w-full md:flex-row mb-8`}>
        <div className="flex-1 flex flex-col justify-start mr-10">
          <img src={logo} alt="hoobank" className="w-[266px] h-[72px] object-contain"/>
          <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Velit, repudiandae.</p>
        </div>

        <div className="flex flex-row flex-[1.5] justify-between flex-wrap md:mt-0 mt-10">
