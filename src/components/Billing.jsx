  ...
  return (
    <section className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        ...
        <div className='absolute z-[3] -left-1/4 top-0 w-[50%] h-[50%] rounded-full white__gradient opacity-40'></div>
        <div className='absolute z-[0] -left-1/2 bottom-0 w-[50%] h-[50%] rounded-full pink__gradient opacity-60'></div>
      </div>
